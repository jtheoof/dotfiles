...
[grid]
s0_put_center_key = <Control><Primary><Alt>KP_5
...
s0_put_maximize_key = <Control><Primary><Alt>Return
...
s0_rotate_to_2_key = <Super>2
s0_rotate_to_3_key = <Super>3
s0_rotate_to_4_key = <Super>4
...
[core]
s0_active_plugins = core;composite;opengl;decor;grid;widget;gnomecompat;resize;snap;imgpng;compiztoolbox;move;mousepoll;vpswitch;regex;place;wall;unitymtgrabhandles;session;animation;expo;ezoom;workarounds;fade;scale;unityshell;scaleaddon;
